...
import imgTODO from "./TodoMERN.PNG"
...
export let projects = [
  ...
  },
  {
    ...
    description:
      "The Todo Application Backend is a server-side implementation designed to support the functionality of a todo application. It provides the necessary APIs and business logic to manage tasks, user authentication, and user data storage.",
    frontendcode:
      "https://github.com/Sivaramanraja98/Mern-Todo-Frontend.git",
    backendcode:
      "https://github.com/Sivaramanraja98/MERN-TODO-BACKEND.git",
