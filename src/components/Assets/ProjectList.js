...
export let projects = [
    {
        ...
        description:"This full-stack application lets you store information about customers to help you track the status of every customer relationshipand this will store and edit customer details, as well as keep notes about them",
    ...
    },
    {
        id:2,
        name:"Gmail Clone",
        description:"Gmail Clone - Authenticated User can send Email and Read Email . User can send, receive & reply mails between them. Multi user communication & Profile picture updation.",
    ...
    },
    {
        ...
        description:"Application that allows users to communicate with each other in real-time via chat messages. Users must sign up and log in to use the app and can send private messages to other users and can see the online status of other users and Users receive notifications when they receive new messages",
        frontendcode:"https://github.com/Sivaramanraja98/chat-application-frontend.git",
        backendcode:"https://github.com/Sivaramanraja98/Chat-Application-Backend.git",
